...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '胸脯', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个不想写代码的大学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiongpu.xyz', // 网站地址
  ...
  //,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin
